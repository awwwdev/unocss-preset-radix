...
<div class="">
  <div v-for="scale in RADIX_HUES" >
    ...
    <div class="flex gap-0.5">
		...
		<div class="flex flex-col gap-0.5 bg-gray1">
      <div v-for="theme in ['dark', 'light']">
        <div class="flex flex-col gap-0.5 bg-gray1 p-2" :class="`${theme}`">
          <div class="flex flex-row gap-0.5">
            <span class="swatch min-w-15 p-4 text-sage11 ">{{ theme }}</span>
            <div class="flex " style="grid-template-columns: repeat(12, 1fr);">
              <div v-for="i in 12">
                <div
                  class="swatch w-10"
          ...
          <div class="flex flex-row gap-0.5  bg-gray1"  :class="`${theme}`">
            <span class="swatch min-w-15 p-4 text-sage11 ">alpha</span>
            <div class="flex bg-gray1 " style="grid-template-columns: repeat(12, 1fr);">
              <div v-for="i in 12">
